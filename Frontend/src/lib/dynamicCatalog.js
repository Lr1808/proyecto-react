...
const pythonPool = [
  ...
  () => ({ question_type: 'CODE_CHALLENGE', question_text: 'Escribe una función que sume dos números y devuelva el resultado.', points: 20, code_validator: 'sum', code_cases: [{ input: '2, 3', expected: '5' }, { input: '-4, 9', expected: '5' }], explanation: 'La función debe recibir dos números y devolver su suma.' }),
  () => ({ question_type: 'CODE_CHALLENGE', question_text: 'Escribe una función invertir(texto) que devuelva el texto al revés.', points: 20, code_validator: 'reverse', code_cases: [{ input: 'hola', expected: 'aloh' }, { input: 'EduEval', expected: 'lavEudE' }], explanation: 'Puedes usar slicing [::-1] o reversed() para invertir el texto.' }),
  () => ({ question_type: 'CODE_CHALLENGE', question_text: 'Escribe una función mayor(a, b) que devuelva el número más grande.', points: 20, code_validator: 'max', code_cases: [{ input: '8, 3', expected: '8' }, { input: '-2, -7', expected: '-2' }], explanation: 'Compara ambos valores y devuelve el mayor, sin imprimirlo.' }),
