...
def main():
    ...
    print("teacher_count=", User.objects.filter(email="admin@example.com").count())
    print("student_count=", User.objects.filter(role=User.Role.STUDENT).count())
    print("exercise_count=", Exercise.objects.count())
    print("test_case_count=", TestCase.objects.count())
    print("admin_email=", teacher.email)
